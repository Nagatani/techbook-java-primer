...
> しかし、プログラミングを学び始めたばかりの初学者にとって、生成AIによるコード生成は「毒」にしかならないことがあります。
> 
> なぜそのような強い表現を使うのでしょうか。
> それは、プログラミング学習の本質が「自分で考え、試行錯誤し、失敗から学ぶプロセス」にあるからです。
...
> 「知識を補う」ツールとして使用する分には、学習を促進する優れた助手となります。
> 
> - 推奨される使い方
...
> ##### 例2：専門用語の理解
> 
> 本書で「オブジェクト指向」という言葉が出てきたが、まだピンとこない。そんなときは以下のように質問します。
> 
> ```
