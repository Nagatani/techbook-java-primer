...
長くて面倒だとは思いますが、すべてのキーワードに意味があり、どれも省くことができません。<span class="footnote">Java 21以降では、学習目的のために簡略化されたmainメソッドの記述が可能になりました。`void main() { ... }`のようにstaticやpublic、引数を省略できます。ただし執筆時点で、実務では従来の形式が望ましく、標準として使われています。</span>
