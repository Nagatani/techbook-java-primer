# <b>22章</b> <span>ユニットテストと品質保証</span> <small>信頼性の高いソフトウェアを作る</small>
...
1. 🔴 Red: まず、これから実装する機能に対する失敗するテストコードを書きます
2. 🟢 Green: そのテストを成功させるための最小限のコードを実装します
3. 🔵 Refactoring: テストが成功する状態を保ったまま、コードをより綺麗に、効率的に書き直します
