...
**学習目標：** thisキーワード、メソッドチェーン、流暢なインターフェイス
...
**学習目標：** 商品管理、価格計算、割引システム

**問題説明：**
ProductクラスとShoppingCartクラスを使用したECサイトのカート機能を実装してください。

### 課題3: ゲームキャラクター（GameCharacter.java）

**学習目標：** ゲーム要素の設計、ステータス管理、アクションシステム

**問題説明：**
RPGゲームのキャラクタークラスを設計し、レベルアップやアイテム使用機能を実装してください。
