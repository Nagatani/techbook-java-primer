...
オブジェクト指向は、プログラミングの歴史の中で生まれた多くのアプローチの1つです。本書では、オブジェクト指向を特別視するのではなく、問題解決のための便利なツールの一つとして学びます。
...
役割ごとに分割することで、大規模なプログラムを作る際に管理しやすくなることがあります。ただし、これは1つのアプローチであり、問題によっては他の分割方法（機能別、レイヤー別など）の方が適切な場合もあります。
