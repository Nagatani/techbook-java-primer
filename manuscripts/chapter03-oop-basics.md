...
├── basic/          # 🟢 基礎レベル（必須）
│   ├── README.md   # 課題の詳細説明
│   ├── Student.java         # 課題1: 基本的なクラス設計
│   ├── StudentTest.java
│   ├── Rectangle.java       # 課題2: オーバーロード実装
│   ├── RectangleTest.java
│   ├── BankAccount.java     # 課題3: thisキーワード活用
│   ├── BankAccountTest.java
│   └── Time.java           # 課題4: 総合基本実装
├── applied/        # 🟡 応用レベル（推奨）
│   ├── README.md
│   ├── BookLibrary.java    # 課題1: 書籍管理システム
│   ├── BookLibraryTest.java
│   ├── ShoppingCart.java   # 課題2: ショッピングカート
│   ├── ShoppingCartTest.java
│   ├── GameCharacter.java  # 課題3: ゲームキャラクター
│   └── GameCharacterTest.java
├── advanced/       # 🔴 発展レベル（挑戦者向け）
│   ├── README.md
│   ├── InventorySystem.java    # 課題1: 在庫管理システム
│   ├── InventorySystemTest.java
│   ├── MusicPlayer.java        # 課題2: 音楽プレイヤー
│   └── MusicPlayerTest.java
└── challenge/      # ⚫ 挑戦レベル（上級者向け）
    ├── README.md
    ├── TaskManager.java        # 課題1: タスク管理システム
    ├── TaskManagerTest.java
    └── MiniFramework.java      # 課題2: 簡易フレームワーク
```
