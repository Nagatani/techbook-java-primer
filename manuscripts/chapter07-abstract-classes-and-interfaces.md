...
本章で学んだ抽象クラスとインターフェイスを実践的な課題で確認しましょう。
...
- 抽象クラスとインターフェイスの適切な使い分け
- テンプレートメソッドパターンの実装
- インターフェイスの多重実装とdefaultメソッドの活用
- 戦略パターンなどのデザインパターンの適用
- SOLID原則に基づいた柔軟な設計

### 課題の概要

1. **基礎課題**: 図形抽象化システム - 抽象クラスとインターフェイスの組み合わせ
2. **発展課題**: 動物行動システム - インターフェイスの多重実装とdefaultメソッド
3. **チャレンジ課題**: ゲームエンジンフレームワーク - 大規模な抽象化設計

詳細な課題内容と実装のヒントは、GitHubリポジトリの各課題フォルダ内のREADME.mdを参照してください。

**次のステップ**: 基礎課題が完了したら、第8章「例外処理」に進みましょう。
