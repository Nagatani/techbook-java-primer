...
たとえば、既存のインターフェイスに新しいメソッドを追加すると、
...
このような制約のため、ライブラリの開発者は新機能を追加する際に既存のAPIを壊してしまうか、新しいインターフェイスを作成するかの難しい選択を迫られていました。
...
<span class="listing-number">**サンプルコード7-35**</span>
