...
**要求仕様：**
1. "1つ目の数値を入力してください: " と表示し、数値を入力受付
2. "2つ目の数値を入力してください: " と表示し、数値を入力受付  
3. "演算子を入力してください (+, -, *, /): " と表示し、演算子を入力受付
...
**学習目標：** 複数演算子の処理、Math クラス、メニュー形式のプログラム
...
**問題説明：**
入力されたテキストを分析し、様々な統計情報を表示するプログラムを作成してください。
...
**問題説明：**
コンピューターがランダムに選んだ1〜100の数値を、ユーザーがヒントを元に当てるゲームを作成してください。
...
**問題説明：**
テキストベースの簡単なRPGゲームエンジンを作成してください。キャラクター、アイテム、戦闘システムを含めます。
