...
本章で学んだ単体テストと品質保証の概念を活用して、実践的な練習課題に取り組みましょう。
...
3. TODOコメントを参考に実装
4. TDDのサイクル（Red-Green-Refactor）を体験する
5. テストカバレッジを意識した包括的なテスト作成を学ぶ

基本課題が完了したら、`advanced/`の発展課題でモックフレームワークや継続的インテグレーションに挑戦してみましょう！
