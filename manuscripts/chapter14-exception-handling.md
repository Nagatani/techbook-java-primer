...
**学習目標：** 完全に型安全なORMシステムの設計、コンパイル時型チェック

**問題説明：**
型安全性を保証するデータベースORMシステムを作成してください。
