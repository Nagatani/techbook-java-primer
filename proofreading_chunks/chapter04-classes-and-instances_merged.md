...
第3章ではコンストラクタの基本的な書き方を学びました。本章では、実践的なアプリケーション開発で必要となる、から高度なコンストラクタ設計パターンを学習します。
...
第3章では`this`の基本的な使い方を学びました。ここでは、から実践的で高度な`this`の活用パターンを学習します。
